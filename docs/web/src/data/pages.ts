...
export const pageMeta: Record<string, PageMeta> = {
  ...
  '/releases': {
    ...
    keywords: [
      ...
      'update', 'history', 'v0.1.0', 'v0.2.0', 'v0.3.0', 'v0.4.0', 'v0.5.0', 'v0.6.0', 'v0.6.1', 'v0.7.0', 'v0.8.0', 'v0.9.0', 'v0.9.1', 'v0.9.2', 'v0.10.0', 'v0.10.1', 'v0.11.0', 'v0.11.1', 'v0.11.2', 'v0.11.3', 'v0.11.4', 'v0.11.5', 'v0.12.0', 'v0.12.1', 'v0.12.2', 'v0.13.0', 'v0.14.0', 'v0.14.1',
    ],
  },
